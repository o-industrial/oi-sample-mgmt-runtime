...
const DISPOSITIONS: DispositionRecord[] = [
  {
    ...
    CustodianSignoff: {
      SignedBy: 'dr.sarah.kumar',
      SignedAt: '2026-04-10 14:00',
    },
    TwoPersonAuth: {
      ScannedBy: 'elena.martinez',
...
const REVIEWS: ReviewRecord[] = [
  ...
  },
  {
    ...
    ReviewedBy: 'elena.martinez',
    ReviewedAt: '2026-04-13 14:30',
    Decision: 'approved',
    LastAction: 'Approved by elena.martinez',
  },
  {
    ...
    Decision: 'rejected',
    LastAction: 'Rejected by elena.martinez — incomplete documentation',
  },
  {
    ...
    Decision: 'escalated',
    LastAction: 'Escalated by elena.martinez — requires CSV Group Head review',
  },
];
...
const NOTIFICATIONS: NotificationRecord[] = [
  ...
  },
  {
    ...
    Message: 'Review REV-2026-0003 approved by elena.martinez',
    Read: true,
