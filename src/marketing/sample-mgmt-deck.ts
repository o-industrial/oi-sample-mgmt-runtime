...
export const sampleMgmtDeck = {
  ...
  absentNotBlocked: {
    ...
    description:
      'Each role sees only their surfaces. Navigation items are filtered server-side by access rights — users who don\'t have access to a feature simply don\'t see it. No disabled buttons, no "access denied." The UI reshapes itself around the role.',
    examples: [
      {
        role: 'Scientist',
  ...
  dashboardScreen: {
    ...
    link: { label: 'Open Dashboard', href: `${SM_DEMO_BASE}/dashboard` },
    transition: 'fade',
  },
  ...
  scientistWorkflow: {
    ...
    steps: [
      'Navigate to / → redirect to /return (scientist lands on their primary workflow, not the dashboard)',
  ...
  csvGroupHeadWorkflow: {
    ...
    steps: [
      'Navigate to / → redirect to /dashboard (admin roles land on the full dashboard)',
  ...
  adminDashboardScreen: {
    ...
    link: { label: 'Open Admin Dashboard', href: `${SM_DEMO_BASE}/dashboard` },
    transition: 'fade',
  },
